...
hunav_msgs__srv__ComputeAgents_Request__init(hunav_msgs__srv__ComputeAgents_Request * msg)
{
  ...
  if (!hunav_msgs__msg__Agents__init(&msg->current_agents)) {
    hunav_msgs__srv__ComputeAgents_Request__fini(msg);
    return false;
  }
  // robot
...
hunav_msgs__srv__ComputeAgents_Request__create()
{
  ...
  hunav_msgs__srv__ComputeAgents_Request * msg = (hunav_msgs__srv__ComputeAgents_Request *)allocator.allocate(sizeof(hunav_msgs__srv__ComputeAgents_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(hunav_msgs__srv__ComputeAgents_Request));
  bool success = hunav_msgs__srv__ComputeAgents_Request__init(msg);
  if (!success) {
...
hunav_msgs__srv__ComputeAgents_Request__Sequence__init(hunav_msgs__srv__ComputeAgents_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  hunav_msgs__srv__ComputeAgents_Request * data = NULL;

  if (size) {
    data = (hunav_msgs__srv__ComputeAgents_Request *)allocator.zero_allocate(size, sizeof(hunav_msgs__srv__ComputeAgents_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = hunav_msgs__srv__ComputeAgents_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        hunav_msgs__srv__ComputeAgents_Request__fini(&data[i - 1]);
      }
...
hunav_msgs__srv__ComputeAgents_Request__Sequence__fini(hunav_msgs__srv__ComputeAgents_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      hunav_msgs__srv__ComputeAgents_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  hunav_msgs__srv__ComputeAgents_Request__Sequence * array = (hunav_msgs__srv__ComputeAgents_Request__Sequence *)allocator.allocate(sizeof(hunav_msgs__srv__ComputeAgents_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = hunav_msgs__srv__ComputeAgents_Request__Sequence__init(array, size);
  if (!success) {
...
hunav_msgs__srv__ComputeAgents_Request__Sequence__destroy(hunav_msgs__srv__ComputeAgents_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    hunav_msgs__srv__ComputeAgents_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
hunav_msgs__srv__ComputeAgents_Request__Sequence__are_equal(const hunav_msgs__srv__ComputeAgents_Request__Sequence * lhs, const hunav_msgs__srv__ComputeAgents_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!hunav_msgs__srv__ComputeAgents_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  hunav_msgs__srv__ComputeAgents_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(hunav_msgs__srv__ComputeAgents_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    hunav_msgs__srv__ComputeAgents_Request * data =
      (hunav_msgs__srv__ComputeAgents_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!hunav_msgs__srv__ComputeAgents_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          hunav_msgs__srv__ComputeAgents_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!hunav_msgs__srv__ComputeAgents_Request__copy(
...
hunav_msgs__srv__ComputeAgents_Response__init(hunav_msgs__srv__ComputeAgents_Response * msg)
{
  ...
  // updated_agents
  if (!hunav_msgs__msg__Agents__init(&msg->updated_agents)) {
    hunav_msgs__srv__ComputeAgents_Response__fini(msg);
    return false;
  }
  return true;
}
...
hunav_msgs__srv__ComputeAgents_Response__fini(hunav_msgs__srv__ComputeAgents_Response * msg)
{
  ...
  // updated_agents
  hunav_msgs__msg__Agents__fini(&msg->updated_agents);
}
...
hunav_msgs__srv__ComputeAgents_Response__are_equal(const hunav_msgs__srv__ComputeAgents_Response * lhs, const hunav_msgs__srv__ComputeAgents_Response * rhs)
{
  ...
  // updated_agents
  if (!hunav_msgs__msg__Agents__are_equal(
      &(lhs->updated_agents), &(rhs->updated_agents)))
  {
    return false;
  }
  return true;
  ...
  hunav_msgs__srv__ComputeAgents_Response * output)
{
  ...
  // updated_agents
  if (!hunav_msgs__msg__Agents__copy(
      &(input->updated_agents), &(output->updated_agents)))
  {
    return false;
  }
  return true;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  hunav_msgs__srv__ComputeAgents_Response * msg = (hunav_msgs__srv__ComputeAgents_Response *)allocator.allocate(sizeof(hunav_msgs__srv__ComputeAgents_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(hunav_msgs__srv__ComputeAgents_Response));
  bool success = hunav_msgs__srv__ComputeAgents_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
hunav_msgs__srv__ComputeAgents_Response__Sequence__init(hunav_msgs__srv__ComputeAgents_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  hunav_msgs__srv__ComputeAgents_Response * data = NULL;

  if (size) {
    data = (hunav_msgs__srv__ComputeAgents_Response *)allocator.zero_allocate(size, sizeof(hunav_msgs__srv__ComputeAgents_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = hunav_msgs__srv__ComputeAgents_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        hunav_msgs__srv__ComputeAgents_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
hunav_msgs__srv__ComputeAgents_Response__Sequence__fini(hunav_msgs__srv__ComputeAgents_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      hunav_msgs__srv__ComputeAgents_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  hunav_msgs__srv__ComputeAgents_Response__Sequence * array = (hunav_msgs__srv__ComputeAgents_Response__Sequence *)allocator.allocate(sizeof(hunav_msgs__srv__ComputeAgents_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = hunav_msgs__srv__ComputeAgents_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
hunav_msgs__srv__ComputeAgents_Response__Sequence__destroy(hunav_msgs__srv__ComputeAgents_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    hunav_msgs__srv__ComputeAgents_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
hunav_msgs__srv__ComputeAgents_Response__Sequence__are_equal(const hunav_msgs__srv__ComputeAgents_Response__Sequence * lhs, const hunav_msgs__srv__ComputeAgents_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!hunav_msgs__srv__ComputeAgents_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  hunav_msgs__srv__ComputeAgents_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(hunav_msgs__srv__ComputeAgents_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    hunav_msgs__srv__ComputeAgents_Response * data =
      (hunav_msgs__srv__ComputeAgents_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!hunav_msgs__srv__ComputeAgents_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          hunav_msgs__srv__ComputeAgents_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!hunav_msgs__srv__ComputeAgents_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
