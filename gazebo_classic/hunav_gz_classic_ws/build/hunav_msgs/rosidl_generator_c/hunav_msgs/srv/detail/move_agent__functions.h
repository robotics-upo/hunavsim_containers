...
#ifndef HUNAV_MSGS__SRV__DETAIL__MOVE_AGENT__FUNCTIONS_H_
#define HUNAV_MSGS__SRV__DETAIL__MOVE_AGENT__FUNCTIONS_H_
...
/// Initialize srv/MoveAgent message.
/**
...
/// Finalize srv/MoveAgent message.
/**
...
/// Create srv/MoveAgent message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * hunav_msgs__srv__MoveAgent_Request__init().
...
/// Destroy srv/MoveAgent message.
/**
 * It calls
 * hunav_msgs__srv__MoveAgent_Request__fini()
...
/// Check for srv/MoveAgent message equality.
/**
...
/// Initialize array of srv/MoveAgent messages.
/**
...
/// Finalize array of srv/MoveAgent messages.
/**
 * It calls
 * hunav_msgs__srv__MoveAgent_Request__fini()
...
/// Create array of srv/MoveAgent messages.
/**
 * It allocates the memory for the array and calls
 * hunav_msgs__srv__MoveAgent_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/MoveAgent messages.
/**
 * It calls
 * hunav_msgs__srv__MoveAgent_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/MoveAgent message array equality.
/**
...
/// Copy an array of srv/MoveAgent messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * hunav_msgs__srv__MoveAgent_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_hunav_msgs
...
/**
 * It calls
 * hunav_msgs__srv__MoveAgent_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_hunav_msgs
...
/**
 * It allocates the memory for the array and calls
 * hunav_msgs__srv__MoveAgent_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_hunav_msgs
...
/**
 * It calls
 * hunav_msgs__srv__MoveAgent_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // HUNAV_MSGS__SRV__DETAIL__MOVE_AGENT__FUNCTIONS_H_
