...
echo -e "\e[36m        HuNavSim Gazebo Fortress System\e[0m"
echo -e "\e[36m_-⁻-_-⁻-_-⁻-_-⁻-_-⁻-_-⁻-_-⁻-_-⁻-_-⁻-__-⁻-_-⁻-_-⁻-_-⁻-_\e[0m"
...
while true; do
    ...
    CONFIG_DIR="/home/hunav_gz_fortress_ws/src/hunav_gazebo_fortress_wrapper/scenarios"
    ...
    if [[ $opt =~ ^[0-9]+$ ]]; then
        ...
        if [ $idx -ge 0 ] && [ $idx -lt ${#yaml_files[@]} ]; then
            ...
            echo ""
            echo "Launching..."
            echo -e "\e[33mros2 launch hunav_gazebo_fortress_wrapper cafe_fortress_test.launch.py configuration_file:=$yaml_name\e[0m"
            echo ""
            ros2 launch hunav_gazebo_fortress_wrapper cafe_fortress_test.launch.py configuration_file:=$yaml_name
