...
#include "hunav_msgs/msg/detail/agent_behavior__rosidl_typesupport_fastrtps_c.h"
...
using _AgentBehavior__ros_msg_type = hunav_msgs__msg__AgentBehavior;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _AgentBehavior__ros_msg_type * ros_message = static_cast<const _AgentBehavior__ros_msg_type *>(untyped_ros_message);
  // Field name: type
  {
  ...
  // Field name: social_force_factor
  {
    cdr << ros_message->social_force_factor;
  }

  // Field name: goal_force_factor
  {
    cdr << ros_message->goal_force_factor;
  }

  // Field name: obstacle_force_factor
  {
    cdr << ros_message->obstacle_force_factor;
  }

  // Field name: other_force_factor
  {
  ...
  void * untyped_ros_message)
{
  ...
  _AgentBehavior__ros_msg_type * ros_message = static_cast<_AgentBehavior__ros_msg_type *>(untyped_ros_message);
  // Field name: type
  {
    cdr >> ros_message->type;
  }
...
static uint32_t _AgentBehavior__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_hunav_msgs__msg__AgentBehavior(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = hunav_msgs__msg__AgentBehavior;
    is_plain =
      (
...
static size_t _AgentBehavior__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_hunav_msgs__msg__AgentBehavior(
...
static message_type_support_callbacks_t __callbacks_AgentBehavior = {
  "hunav_msgs::msg",
  "AgentBehavior",
...
static rosidl_message_type_support_t _AgentBehavior__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_AgentBehavior,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, hunav_msgs, msg, AgentBehavior)() {
  return &_AgentBehavior__type_support;
}
