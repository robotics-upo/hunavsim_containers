...
static const _AgentBehavior_type_support_symbol_names_t _AgentBehavior_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, hunav_msgs, msg, AgentBehavior)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, hunav_msgs, msg, AgentBehavior)),
  }
};
...
{
  return &::hunav_msgs::msg::rosidl_typesupport_cpp::AgentBehavior_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, hunav_msgs, msg, AgentBehavior)() {
  return get_message_type_support_handle<hunav_msgs::msg::AgentBehavior>();
}
