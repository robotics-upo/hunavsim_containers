...
echo -e "\e[36m        HuNavSim Webots System\e[0m"
echo -e "\e[36m_-⁻-_-⁻-_-⁻-_-⁻-_-⁻-_-⁻-_-⁻-_-⁻-_-⁻-__-⁻-_-⁻-_-⁻-_-⁻-_\e[0m"

# Source ROS and the workspace inside the docker container
source /opt/ros/humble/setup.bash
source /home/webots_ws/install/setup.bash
error=false
...
source /home/hunav_webots_ws/install/setup.bash
...
while true; do
    ...
    CONFIG_DIR="/home/hunav_webots_ws/src/hunav_webots_wrapper/scenarios"
    ...
    if [[ $opt =~ ^[0-9]+$ ]]; then
        ...
        if [ $idx -ge 0 ] && [ $idx -lt ${#yaml_files[@]} ]; then
            ...
            echo ""
            echo "Launching..."
            echo -e "\e[33mros2 launch hunav_webots_wrapper hunavsim_launch_$map_name.py\e[0m"
            echo ""
            ros2 launch hunav_webots_wrapper hunavsim_launch_$map_name.py
